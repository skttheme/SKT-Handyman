...
define('SKT_HANDYMAN_SKTTHEMES_URL','https://www.sktthemes.org/');
define('SKT_HANDYMAN_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/handyman-wordpress-theme');
define('SKT_HANDYMAN_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-handyman-wordpress-theme');
define('SKT_HANDYMAN_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/skt-handyman-doc');
define('SKT_HANDYMAN_SKTTHEMES_LIVE_DEMO','https://sktthemesdemo.net/handyman');
define('SKT_HANDYMAN_SKTTHEMES_THEMES','https://www.sktthemes.org/themes');
/**
...
add_action( 'tgmpa_register', 'skt_handyman_register_required_plugins' );
 
function skt_handyman_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
