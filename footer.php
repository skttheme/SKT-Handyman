...
<div class="container">
     <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-handyman');?> <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-handyman-wordpress-theme/');?>" target="_blank">
        <?php esc_html_e('SKT Handyman','skt-handyman'); ?>
        </a></div>
     <div class="clear"></div>
</div>           
</div>
